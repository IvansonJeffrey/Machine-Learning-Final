...
def main():
    ...
    parser.add_argument('--data_root', type=str,
                        default=r"C:\Users\Jeffrey M. Ivanson\Documents\Machine Learning Final\dataset",
                        help='Path to dataset')
    parser.add_argument('--mode', type=str, choices=['train','infer'], default='infer')
    parser.add_argument('--image', type=str, default=r"C:\Users\Jeffrey M. Ivanson\Documents\Machine Learning Final\54503.jpg", help='Path to input image for inference')
